...
# ✅ Update File Uploader to Accept PDF, Word, and PowerPoint Files
uploaded_files = st.file_uploader("Upload your files (CSV, Excel, Word, PowerPoint, PDF):", 
                                  type=["csv", "xlsx", "docx", "pptx", "pdf"], 
...
if uploaded_files:
    for file in uploaded_files:
        ...
        conversion_type = st.radio(
            f"Convert {file.name} to:", ["CSV", "Excel", "PDF", "PowerPoint", "Word"], key=file.name
        )
